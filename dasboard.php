...
<body id="page-top">
  ...
  <section id=checkRegistrations>
    <div class="container">
      ...
      <?php
        $query = "SELECT e.event_id, e.event_title, e.event_price, e.participants, e.type_id, et.type_name, e.event_date, e.start_time, e.end_time, e.event_location, e.organizer_name, e.organizer_email, e.registration_deadline
                  FROM events e
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-8">
                    ...
                    <h6 class="card-subtitle mb-2 text-muted"><?php echo $row['type_name']; ?></h6>
